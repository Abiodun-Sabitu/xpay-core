export const debitAlertMail = (transactionDetails, firstName) => {
...
<body>
<div class="container">
  <div class="header">DEBIT ALERT - x-PAY WALLET</div>
  <div class="content">
    <p>Hello <strong>${firstName}</strong>,</p>
    <p>Your wallet with Account No: <strong>${transactionDetails.sender.walletId}</strong> was debited on <strong>${transactionDetails.date}</strong>.</p>
    <p><strong>Details:</strong></p>
    <ul>
      
      <li><strong>Amount Debited:</strong> ${transactionDetails.amount}</li>
      ...
      <li><strong>Transaction ID:</strong> ${transactionDetails.transactionId}</li>
			<li><strong>Beneficiary:</strong> ${transactionDetails.receiver.name}</li>
